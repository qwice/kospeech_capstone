...
DATASET_PATH="/content/drive/MyDrive/Korean/KsponSpeech"
VOCAB_DEST='/content/drive/MyDrive/kospeech/data'
OUTPUT_UNIT='character'                                          # you can set character / subword / grapheme
PREPROCESS_MODE='phonetic'                                       # phonetic : 칠 십 퍼센트,  spelling : 70%
VOCAB_SIZE=100                                                  # if you use subword output unit, set vocab size
